        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {events.map((event) => {
            ...
            return (
              <div
                key={event.id}
                className="bg-white rounded-2xl border-2 border-slate-300 shadow-md hover:border-purple-600 transition overflow-hidden flex flex-col justify-between"
              >
                <div className="p-6">
                  <div className="flex items-center justify-between gap-2 mb-4">
                    ...
                    <span className="px-3 py-1 bg-slate-200 text-slate-950 text-xs font-black rounded border border-slate-400">
                      {event.badge}
                    </span>
                  </div>
                  ...
                  <p className="text-slate-800 text-base font-medium leading-relaxed mb-6">
                    {event.description}
                  </p>
